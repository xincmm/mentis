"""Tavily search tools for the multi-agent architecture.

This module contains tools for performing web searches using the Tavily API,
providing agents with the ability to retrieve information from the internet.
"""
import json
